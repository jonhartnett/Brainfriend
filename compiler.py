...
max_memory = int(1e9)
start_memory = max_memory // 2
max_memory = str(max_memory)
start_memory = str(start_memory)
...
def commands_to_c(commands, name, maincall=True, indentlevel=1):
	...
	if maincall:
		...
		result += indent("}", 0)
		result += indent("", 0)
		result += indent("static uint8_t mem["+max_memory+"] = {0};", 0)
		result += indent("", 0)
		result += indent("int main(void) {", 0)
		result += indent("uint8_t *p = &mem["+start_memory+"];")
		result += indent("")
...
def commands_to_java(commands, name, maincall=True, indentlevel=2):
	...
	if maincall:
		...
		result += indent("byte[] mem = new byte["+max_memory+"];")
		result += indent("int i = "+start_memory+";")
		result += indent("")
...
def commands_to_python(commands, name, maincall=True, indentlevel=0):
	...
	if maincall:
		...
		result += indent("")
		result += indent("mem = [0] * "+max_memory)
		result += indent("i = "+start_memory)
		result += indent("")
